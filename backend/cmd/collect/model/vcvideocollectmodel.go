...
func NewVcVideoCollectModel(conn sqlx.SqlConn, c cache.CacheConf, opts ...cache.Option) VcVideoCollectModel {
	return &customVcVideoCollectModel{
		defaultVcVideoCollectModel: newVcVideoCollectModel(conn, c, opts...),
	}
}
