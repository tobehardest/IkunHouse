...
type (
	CollectItem    = collect.CollectItem
	...
	UnCollectReq   = collect.UnCollectReq
	UnCollectRes   = collect.UnCollectRes
...
// 取消收藏
func (m *defaultCollect) UnCollect(ctx context.Context, in *UnCollectReq, opts ...grpc.CallOption) (*UnCollectRes, error) {
	client := collect.NewCollectClient(m.cli.Conn())
