...
// UserClient is the client API for User cmd.
//
...
// UserServer is the server API for User cmd.
...
// UnsafeUserServer may be embedded to opt out of forward compatibility for this cmd.
...
// User_ServiceDesc is the grpc.ServiceDesc for User cmd.
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "cmd/user-cmd/rpc/user.proto",
}
